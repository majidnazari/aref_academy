    ...
    protected static function boot()
    {
        ...
        static::updated(function ($consultantDefinitionDetail) use ($latestId) {
            ...
            if ($consultant_report_exististance &&  isset($student_info)) {
                Log::info("if update this is runnin");
                ...
                $consultant_report_exististance["sum_all_consultant_present_session"] += $consultantDefinitionDetail->student_status === "present" ? 1 : 0;
                ...
                // Log::info("else update this is runnin");
                // Log::info("student ifo is:". json_encode($student_info));
                ...
                $consultant_report_exististance->sum_all_consultant_non_attendance_session += $consultantDefinitionDetail->remote ? 1 : 0;
                $consultant_report_exististance->sum_all_consultant_attendance_session += $consultantDefinitionDetail->remote == false ? 1 : 0;
                $consultant_report_exististance->sum_all_consultant_compensation_session += $consultantDefinitionDetail->compensatory_for_definition_detail_id > 0  ? 1 : 0;
