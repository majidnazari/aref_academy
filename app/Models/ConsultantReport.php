...
class ConsultantReport extends Model implements Auditable
{
    ...
    protected $fillable = [
        ...
        "sum_compensatory_meet_",
        "sum_single_meet_1",
        "sum_single_meet_0",
        "sum_remote_1",
        "sum_remote_",

        "sum_manager_status_approved",
        "sum_manager_status_pending",
        "sum_financial_status_approved",
        "sum_financial_status_pending",
        "sum_financial_status_semi_approved",
        ...
        "sum_financial_refused_status_not_returned",
        "sum_financial_refused_status_returned",
        "sum_financial_refused_status_noMoney",
