...
class ConsultantDefinitionDetailPolicy
{
    ...
    private $group_access_consultant_definition_detail=array("admin","manager","acceptor");
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function delete(User $user, ConsultantDefinitionDetail $consultantDefinitionDetail)
    {
        $user_role=auth()->guard('api')->user()->group->type;       
        if(in_array($user_role,$this->group_access_consultant_definition_detail))
            return true;
