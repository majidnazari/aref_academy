...
class StudentWarningPolicy
{
    ...
    private $group_access_student_warning=array("admin","manager");
     ...
     * @return \Illuminate\Auth\Access\Response|bool
     */
    public function view(User $user, StudentWarning $studentWarning)
    {
       return $this->get_accessibility();
    ...
    public function get_accessibility()
    {
        ...
        if(in_array($user_role,$this->group_access_student_warning))
            return true;
        return false;
    }
}
