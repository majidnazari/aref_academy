...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\StudentWarningHistory>
 */
class StudentWarningHistoryFactory extends Factory
{
    /**
    ...
    public function definition()
    {
        ...
        return [
            ...
            "response" => $this->faker->randomElement(["noAction"]),
