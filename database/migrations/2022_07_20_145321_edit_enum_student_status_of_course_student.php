...
return new class extends Migration
{
    ...
    {
        DB::statement("ALTER TABLE `course_students`  CHANGE `student_status` `student_status` ENUM('ok', 'refused', 'fired') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'ok'");
        // Schema::table('course_students', function (Blueprint $table) {
        //     //
        // });
    }
