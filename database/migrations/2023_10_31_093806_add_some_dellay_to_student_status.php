...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('consultant_definition_details', function (Blueprint $table) {
            DB::statement("ALTER TABLE `consultant_definition_details`  CHANGE `student_status` `student_status` ENUM('absent', 'present', 'no_action','dellay5','dellay10','dellay15','dellay15more') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'no_action'");
        });
    }
